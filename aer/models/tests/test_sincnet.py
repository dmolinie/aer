...
def test_SincNet_no_conv_no_fc_no_rec_chks():
    ...
    # No layers
    model = SincNet(input_shape, nb_classes=4,
...
def test_SincNet_no_conv_no_fc_no_rec_seqs():
...
def test_SincNet_multiconv_chks():
    ...
    # Instantiate the model
    model = SincNet(input_shape, nb_classes=4,
        scl_params=scl_params, reg_scl=reg_conv1,
        conv_params=(cv_params2, cv_params3),
        reg_conv=(reg_conv2, reg_conv3))
    summary(model, input_size=input_shape)
    # Forward the testing data to the model
    model.eval()
    output = model.forward(data)
...
def test_SincNet_multiconv_seqs():
...
test_SincNet_no_conv_no_fc_no_rec_chks()

test_SincNet_no_conv_no_fc_no_rec_seqs()

test_SincNet_default_chks()

test_SincNet_default_seqs()

test_SincNet_1cv_1fc_chks()

test_SincNet_1cv_1fc_seqs()

test_SincNet_multiconv_chks()

test_SincNet_multiconv_seqs()

test_SincNet_multifc_chks()

test_SincNet_multifc_seqs()
